...
<head>
    ...
    <link rel="stylesheet" href="to-do list/Untitled-1.css"> <!-- Link to your CSS file -->
...
<div class="jumbotron text-center" style="padding-top: 80px; padding-bottom: 30px; margin-top: 100px;background-color: #1edbdb;">
        ...
        <div class="jumbotron text-center">
            ...
            if ($_SERVER["REQUEST_METHOD"] == "POST") {
                ...
                if (mysqli_query($connection, $sql)) {
                    echo "YOUR COMMENT WAS SUBMITTED SUCCESSFULLY! TNXS FOR YOUR FEEDBACK";
                } else {
    ...
    <script src="to-do list/todo.js"></script> <!-- Link to your JavaScript file -->
